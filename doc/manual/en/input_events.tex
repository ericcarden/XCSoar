...
and when. There is a new concept called Input Mode - this is the
...
preference.  And all configurable as plain text, simple files. There
...
Another benefit of these Macros is User Defined Flight
